...
for x in range(1,10):
    ...
    for property in content: 
        ...
        #recurring = soup.find('div', class_ = 'mdc_repeat_bar')
        #multiphase = soup.find('div', class_ = 'mdc_series_bar')
